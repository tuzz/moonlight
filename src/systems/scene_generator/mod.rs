...
impl<'a> System<'a> for SceneGenerator {
    ...
    fn run(&mut self, (entities, lazy): Self::SystemData) {
        ...
        lazy.insert(camera, Image::new(Vector2::new(3840, 2160)));
        ...
        lazy.insert(sphere1, Shape::new(Sphere::new()));
        ...
        lazy.insert(sphere2, Shape::new(Sphere::new()));
        ...
        lazy.insert(sphere3, Shape::new(Sphere::new()));
        ...
        lazy.insert(sphere4, Shape::new(Sphere::new()));
        ...
        lazy.insert(sphere5, Shape::new(Sphere::new()));
        ...
        lazy.insert(sphere6, Shape::new(Sphere::new()));
        ...
        lazy.insert(sphere7, Shape::new(Sphere::new()));
        ...
        lazy.insert(sphere8, Shape::new(Sphere::new()));
